...
import { getFlights, handleflightbooking } from "@/api";
...
const BookFlightPage = () => {
    ...
    const fetchFlight = async () => {
      try {
        ...
        const selectedFlight = data.find(
          (item: Flight) => String(item.id) === String(id),
        );
  ...
  const handleQuantityChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setQuantity(Math.max(1, Math.min(value, flight.availableSeats)));
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="flex flex-wrap justify-between items-start gap-4 mb-6">
                <div>
                  <div className="flex items-center flex-wrap gap-4 mb-2">
                    <h2 className="text-lg text-black font-bold flex items-center">
                ...
                {hotels.map((hotel, index) => (
                  ...
                  >
                    <div className="relative">
                      ...
                      <div className="absolute top-3 right-3 bg-white text-xs px-2 py-1 rounded-full font-medium text-black">
                        Best Seller
                      </div>
                    </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl shadow-sm p-6 sticky top-24">
              <h2 className="text-lg text-black font-bold mb-6 flex items-center">
              ...
              <Dialog open={open} onOpenChange={setOpen}>
                <DialogTrigger className="w-full bg-red-600 text-white mt-6 rounded-md px-4 py-2 hover:bg-red-700">
                  Book Now
                </DialogTrigger>
